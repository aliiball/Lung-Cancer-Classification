...
# DenseNet121 temel model (başlık kısmı hariç)
base_model = DenseNet121(weights='imagenet', include_top=False, input_shape=(224, 224, 3))

# Fine-tuning: son birkaç katman hariç donduruluyor
...
model_checkpoint = ModelCheckpoint(
    "C:\\Projects\\DenseNet121_Model\\LungCancerApp\\app\\densenet121_best_model.h5",
    monitor='val_loss',
    save_best_only=True,
    mode='min',
    verbose=1
